...
+
image::sql-awsec2-image1.png[SQL awsec2イメージ1]

. fsxadminのパスワードを指定します。
+
image::sql-awsec2-image2.png[SQL awsec2イメージ2]

. SVMのパスワードを指定します。
+
image::sql-awsec2-image3.png[SQL awsec2イメージ3]
...
....
+
image::sql-awsec2-image4.png[SQL awsec2イメージ4]
...
....
+
image::sql-awsec2-image5.png[SQL awsec2イメージ5]
...
....
+
image::sql-awsec2-image6.png[SQL awsec2イメージ6]
...
+
image::sql-awsec2-image7.png[SQL awsec2イメージ7]
...
....
+
image::sql-awsec2-image10.png[SQL awsec2イメージ10]
...
....
+
image::sql-awsec2-image11.png[SQL awsec2イメージ11]
...
....
+
image::sql-awsec2-image12.png[SQL awsec2イメージ12]
...
image::sql-awsec2-image13.png[SQL awsec2イメージ13]
...
+
image::sql-awsec2-image17.png[SQL awsec2イメージ17]

+
LUNがすでにプロビジョニングされている場合は、ホストログディレクトリを表すマウントポイントを選択できます。

+
image::sql-awsec2-image18.png[SQL awsec2イメージ18]
...
. クローンを作成するバックアップ名を選択し、Cloneを選択します。
+
image::sql-awsec2-image26.png[SQL awsec2イメージ26]

. バックアップからのクローン作成の手順に従い、EC2に新しいSQL Serverインスタンスを指定し、インスタンス名を指定してクローンプロセスを終了します。
. Monitorを選択して、クローニングが完了したことを確認します。
+
image::sql-awsec2-image27.png[SQL awsec2イメージ27]
