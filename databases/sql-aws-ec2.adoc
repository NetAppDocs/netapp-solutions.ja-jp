...
link:https://netapp.hosted.panopto.com/Panopto/Pages/Viewer.aspx?id=27f28284-433d-4273-8748-b01200fb3cd7["AWS FSx for ONTAPを使用して、Amazon EC2にSQL Serverを導入します"]
