...
* 一般的な手順と、OracleとAmazon FSx ONTAPに関連するセクションを確認してくださいlink:https://docs.netapp.com/us-en/cloud-manager-backup-restore/concept-protect-cloud-app-data-to-cloud.html#architecture["クラウドネイティブアプリケーションのデータを保護"^]。
* 次のビデオチュートリアルをご覧ください。
