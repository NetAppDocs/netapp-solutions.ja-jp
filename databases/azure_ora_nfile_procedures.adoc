...
+
[azacsnap@aco-ora01 bin]$azacsnap-c test --test oracle --configfile azacsnap.json begin：「oracle」BEGIN：Test process started for 'Oracle' BEGIN：Oracle DB test passed：Successful connectivity to Oracle DB version 1908000000 end：Test process complete for 'Oracle'[azacsnap@aco-ora01]
