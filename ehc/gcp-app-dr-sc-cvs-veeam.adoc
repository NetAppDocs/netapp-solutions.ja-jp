...
SnapCenter の設定およびデータのレプリケートの手順の例については、を参照してください https://docs.netapp.com/us-en/netapp-solutions/ehc/aws-guest-dr-config-snapmirror.html["SnapCenter を使用してレプリケーションを設定する"]
