...
注：データストアとしてのネットアップストレージは、現在、AWS / VMCとAzure / AVSのパブリックプレビューと、GCP / GSVEのプライベートプレビューとして提供されています。詳細については、次のリンクを参照してください。

まもなくNFSデータストアの補足として、FSX ONTAP のAWSプレスリリースがリリースされます。

link:https://docs.microsoft.com/en-us/azure/azure-vmware/attach-azure-netapp-files-to-azure-vmware-solution-hosts?branch=main&tabs=azure-portal/["Azure NetApp Files （ANF）をAzureの補助的なNFSデータストアとして使用できます"]
link:https://www.netapp.com/google-cloud/google-cloud-vmware-engine-registration/["GCPの追加のNFSデータストアであるCloud Volumes Service （CVS）"]
...
link:https://docs.microsoft.com/en-us/azure/azure-vmware/attach-azure-netapp-files-to-azure-vmware-solution-hosts?branch=main&tabs=azure-portal/["Azure NetApp Files （ANF）は、Azure向けNFSデータストアとして追加されたものです"]
link:https://www.netapp.com/google-cloud/google-cloud-vmware-engine-registration/["GCPの補足的なNFSデータストアであるCloud Volumes Service （CVS）"]
