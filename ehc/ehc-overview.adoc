...
AWS Press release for FSX ONTAP as a native datastore Soon Soiling！

link:https://docs.microsoft.com/en-us/azure/azure-vmware/attach-azure-netapp-files-to-azure-vmware-solution-hosts?branch=main&tabs=azure-portal/["Azure のネイティブデータストアとしての Azure NetApp Files （ ANF"]
