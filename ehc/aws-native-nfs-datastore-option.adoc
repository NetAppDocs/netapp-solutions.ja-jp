...
+
image::fsx-nfs-image2.png[FSx NFSイメージ2]

. 作成方法には、*標準作成*を選択します。
+
image::fsx-nfs-image3.png[FSx NFSイメージ3]

+
image::fsx-nfs-image4.png[FSx NFSイメージ4]
...
+
image::fsx-nfs-image5.png[FSx NFSイメージ5]
...
+
image::fsx-nfs-image6.png[FSx NFSイメージ6]
...
+
image::fsx-nfs-image7.png[FSx NFSイメージ7]
...
....
+
image::fsx-nfs-image8.png[FSx NFSイメージ8]

+
image::fsx-nfs-image9.png[FSx NFSイメージ9]
...
+
image::fsx-nfs-image10.png[FSx NFSイメージ10]

+
image::fsx-nfs-image11.png[FSx NFSイメージ11]
...
+
image::fsx-nfs-image12.png[FSx NFSイメージ12]
...
+
image::fsx-nfs-image13.png[FSx NFSイメージ13]
...
+
image::fsx-nfs-image14.png[FSx NFSイメージ14]
...
+
image::fsx-nfs-image15.png[FSx NFSイメージ15]
...
+
image::fsx-nfs-image16.png[FSx NFSイメージ16]
...
+
image::fsx-nfs-image17.png[FSx NFSイメージ17]

. [*トランジットゲートウェイの添付ファイルの作成*]をクリックします。
+
image::fsx-nfs-image18.png[FSx NFSイメージ18]

. VMware Cloud Consoleに戻り、SDDC Group > External VPCタブに戻ります。FSXに使用するAWSアカウントIDを選択し、VPCをクリックして* Accept *をクリックします。
+
image::fsx-nfs-image19.png[FSx NFSイメージ19]

+
image::fsx-nfs-image20.png[FSx NFSイメージ20]
...
+
image::fsx-nfs-image21.png[FSx NFSイメージ21]

+
image::fsx-nfs-image22.png[FSx NFSイメージ22]
...
+
image::fsx-nfs-image27.png[FSx NFSイメージ27]
...
+
image::fsx-nfs-image28.png[FSx NFSイメージ28]

. データストアの接続*をクリックして、データストアをクラスタに接続します。
+
image::fsx-nfs-image29.png[FSx NFSイメージ29]

. 次の図のようにvCenterにアクセスしてNFSデータストアを検証します。
+
image::fsx-nfs-image30.png[FSx NFSイメージ30]
