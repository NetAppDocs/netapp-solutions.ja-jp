...
* link:/ehc/azure/azure-setup.html#register["リソースプロバイダを登録し、プライベートクラウドを作成"]
* link:/ehc/azure/azure-setup.html#connect["新しい ExpressRoute 仮想ネットワークゲートウェイまたは既存の ExpressRoute 仮想ネットワークゲートウェイに接続します"]
* link:/ehc/azure/azure-setup.html#validate["ネットワーク接続を検証し、プライベートクラウドにアクセス"]
...
* link:/ehc/aws/aws-setup.html#deploy["VMware Cloud for AWS を導入して設定"]
* link:/ehc/aws/aws-setup.html#connect["VMware Cloud を FSX ONTAP に接続します"]
