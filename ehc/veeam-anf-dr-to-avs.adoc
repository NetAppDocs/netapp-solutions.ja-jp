...
image::dr-veeam-anf-image1.png[DR Veeam Anfイメージ1]
...
+
image::dr-veeam-anf-image2.png[DR Veeam Anfイメージ2]
...
+
image::dr-veeam-anf-image6.png[DR Veeam Anfイメージ6]

. レプリケーションジョブを定期的に実行するレプリケーションスケジュールを選択します。
+
image::dr-veeam-anf-image7.png[DR Veeam Anfイメージ7]
...
+
image::dr-veeam-anf-image8.png[DR Veeam Anfイメージ8]



レプリケーションジョブが開始されると、指定されたサフィックスのVMがデスティネーションAVS SDDCクラスタ/ホストに取り込まれます。

image::dr-veeam-anf-image9.png[DR Veeam Anfイメージ9]
...
image::dr-veeam-anf-image13.png[Veeam先生の画像13]

image::dr-veeam-anf-image14.png[Veeam先生の画像14]

VMレプリカの状態がReadyからFailoverに変わり、デスティネーションAzure VMware解決策（AVS）SDDCクラスタ/ホストでVMが起動します。

image::dr-veeam-anf-image15.png[Veeam先生の画像15]

フェイルオーバーが完了すると、VMのステータスが「Failover」に変わります。

image::dr-veeam-anf-image16.png[Veeam先生の画像16]
...
image::dr-veeam-anf-image17.png[Veeam先生の画像17]

image::dr-veeam-anf-image18.png[Veeam先生の画像18]

image::dr-veeam-anf-image19.png[Veeam先生の画像19]

image::dr-veeam-anf-image20.png[Dr Veeam Anfイメージ20]
...
image::dr-veeam-anf-image21.png[Veeam先生の画像21]

本番環境へのフェイルバックが成功すると、VMはすべて元の本番サイトにリストアされます。

image::dr-veeam-anf-image22.png[Veeam先生の画像22]
