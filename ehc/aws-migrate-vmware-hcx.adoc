...
. 既存のVMC SDDCを使用するか、次の手順で新しいSDDCを作成します https://docs.netapp.com/us-en/netapp-solutions/ehc/aws-setup.html["ネットアップのリンク"^] またはこれ https://docs.vmware.com/en/VMware-Cloud-on-AWS/services/com.vmware.vmc-aws.getting-started/GUID-EF198D55-03E3-44D1-AC48-6E2ABA31FF02.html["VMwareへのリンク"^]。
