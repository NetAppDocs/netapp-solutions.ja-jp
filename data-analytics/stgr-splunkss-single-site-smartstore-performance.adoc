...
image::stgr-splunkss-image11.png[stgr splunkssイメージ11]
...
image::stgr-splunkss-image12.png[stgr splunkssイメージ12]
...
image::stgr-splunkss-image13.png[stgr splunkssイメージ13]

パフォーマンス情報はクラスタマスターから収集しました。ピークパフォーマンスは61.34GBpsです。

image::stgr-splunkss-image14.png[stgr splunkssイメージ14]

平均パフォーマンスは約29GBpsです。

image::stgr-splunkss-image15.png[stgr splunkssイメージ15]
...
image::stgr-splunkss-image16.png[stgr splunkssイメージ16]

StorageGRID で検索を実行するクエリを次の図に示すように、StorageGRID からのS3読み出し速度の時間が表示されます。

image::stgr-splunkss-image17.png[stgr splunkssイメージ17]
...
image::stgr-splunkss-image18.png[stgr splunkssイメージ18]
