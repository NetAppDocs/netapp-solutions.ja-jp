...
link:confluent-kafka-performance-tests-with-scalability.html["Previous ：拡張性を備えたパフォーマンステスト。"]
...
+
....
root@stlrx2540m4-01:~# aws s3 –endpoint-url .rtpppe.netapp.com:10444 ls kafkasgdbucket1-2
...
link:confluent-kafka-confluent-kafka-rebalance.html["次は、 Conluent Kafka rebalance です。"]
