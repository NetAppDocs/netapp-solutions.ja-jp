...
. Ansible 制御ホストとして使用できるように Linux ホストを設定するには、 link:../automation/automation_rhel_centos_setup.html["RHEL 7/8 または CentOS 7/8 の場合は、こちらをクリックしてください"] または link:../automation/automation_ubuntu_debian_setup.html["Ubuntu / Debian の場合はこちら"]。
