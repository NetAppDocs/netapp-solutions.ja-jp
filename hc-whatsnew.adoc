...
| link:containers/devops_with_netapp/dwn_solution_overview.html["ネットアップAstraを使用したDevOps"] | link:containers/rh-os-n_videos_astra_control_flexclone.html["ビデオ： Accelerate Software Development with Astra Control and NetApp FlexClone Technology"] 
