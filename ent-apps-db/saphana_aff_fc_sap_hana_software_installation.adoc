---
sidebar: sidebar 
permalink: ent-apps-db/saphana_aff_fc_sap_hana_software_installation.html 
...
link:saphana_aff_fc_adding_additional_data_volume_partitions_for_sap_hana_single-host_systems.html["次の手順： SAP HANA シングルホストシステムのデータボリュームパーティションを追加します"]
