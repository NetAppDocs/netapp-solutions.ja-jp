---
sidebar: sidebar 
permalink: ent-apps-db/saphana_aff_nfs_sap_hana_software_installation.html 
...
link:saphana_aff_nfs_sap_hana_data_volume_size.html["Previous ： SAP HANA データボリュームのサイズ。"]
...
link:saphana_aff_nfs_adding_additional_data_volume_partitions.html["次：データボリュームのパーティションを追加しています"]
