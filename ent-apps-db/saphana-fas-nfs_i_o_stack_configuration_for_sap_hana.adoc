...
link:saphana-fas-nfs_sap_hana_installation_preparations_for_nfsv4.html["以前： NFSv4 を使用するための SAP HANA のインストール準備。"]
...
....
link:saphana-fas-nfs_sap_hana_data_volume_size.html["次の例： SAP HANA データのボリュームサイズ"]
