...
. Ansible 制御ホストとして使用できるように Linux ホストを設定するには、link:../automation/automation_rhel_centos_setup.html["RHEL 7/8 または CentOS 7/8 の場合は、こちらをクリックしてください"]または
...
準備ができたら、をクリックします link:awx_automation.html["AWX/Tower の導入手順の詳細については、こちらを参照してください"] または 。
