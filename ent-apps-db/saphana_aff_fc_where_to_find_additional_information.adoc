...
link:saphana_aff_fc_adding_additional_data_volume_partitions_for_sap_hana_single-host_systems.html["前の手順： SAP HANA シングルホストシステムのデータボリュームパーティションを追加"]
...
link:saphana_aff_fc_update_history.html["次：履歴を更新します。"]
