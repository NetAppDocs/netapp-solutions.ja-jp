...
| Scikit learn | Scikit-Learn には、数十の機械学習アルゴリズムとモデルが組み込まれています。これらは、試算ツールと呼ばれます。各 https://scikit-learn.org/stable/glossary.html#term-estimators["エスティメータ"^] は、を使用して一部のデータに装着できます メソッド 
|===
