...
+
image:sc_host_setup.png["エラー：グラフィックイメージがありません"]
...
+
image:sc_resource_vectordatabase.png["エラー：グラフィックイメージがありません"]
...
+
image:sc_backup_vector_database.png["エラー：グラフィックイメージがありません"]
...
+
image:sc_restore_vector_database.png["エラー：グラフィックイメージがありません"]
