...
BlueXPを使用した3-2-1バックアップ戦略の詳細については、 https://docs.netapp.com/us-en/netapp-solutions/ehc/bxp-scv-hybrid-solution.html["3-2-1 SnapCenterプラグインとBlueXPによるVMのバックアップとリカバリによるVMwareのデータ保護"]。
...
* * ONTAPツールを使用して、VCF管理ドメインにiSCSIデータストアを導入します*。をクリックします https://docs.netapp.com/us-en/netapp-solutions/virtualization/vmware_vcf_asa_supp_mgmt_iscsi.html["*ここ*"] を参照してください。
* * ONTAPツールを使用して、VVOL（iSCSI）データストアをVIワークロードドメインに導入します*。をクリックします https://docs.netapp.com/us-en/netapp-solutions/virtualization/vmware_vcf_asa_supp_wkld_vvols.html["*ここ*"] を参照してください。
* * NVMe over TCPデータストアをVIワークロードドメインで使用するように設定します*。をクリックします https://docs.netapp.com/us-en/netapp-solutions/virtualization/vmware_vcf_asa_supp_wkld_nvme.html["*ここ*"] を参照してください。
* * SnapCenter Plug-in for VMware vSphereを導入して使用し、VIワークロードドメイン内のVMを保護およびリストアします*。をクリックします https://docs.netapp.com/us-en/netapp-solutions/virtualization/vmware_vcf_asa_scv_wkld.html["*ここ*"] を参照してください。
