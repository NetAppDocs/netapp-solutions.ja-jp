...
* https://["NetApp Pub"^]。ネットアップの構成管理と自動化：
* https://["VMware 向けの Ansible Galaxy Community"^]。VMware 向けの Ansible リソースの集まり。
* https://["VMware ｛ code ｝ のリソース"^]。フォーラム、設計基準、サンプルコード、開発者ツールなど、ソフトウェア定義データセンターのソリューションを設計するために必要なリソース。
