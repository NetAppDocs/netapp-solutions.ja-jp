...
NetApp SnapCenter Plug-in for VMware vSphere の詳細については、を参照してください https://docs.netapp.com/ocsc-42/index.jsp?topic=%2Fcom.netapp.doc.ocsc-con%2FGUID-29BABBA7-B15F-452F-B137-2E5B269084B9.html["NetApp SnapCenter Plug-in for VMware vSphere の概要"^]。



== ネットアップとネットアップの SnapCenter ビデオシリーズ

* https://docs.netapp.com/us-en/netapp-solutions/virtualization/scv_videos_deployment.html["SnapCenter Plug-in for VMware vSphere - 導入"^]
* https://docs.netapp.com/us-en/netapp-solutions/virtualization/scv_videos_prerequisites.html["VMware vSphere 解決策 用の SnapCenter プラグインの前提条件"^]
* https://docs.netapp.com/us-en/netapp-solutions/virtualization/scv_videos_backup_workflow.html["SnapCenter Plug-in for VMware vSphere - バックアップワークフロー"^]
* https://docs.netapp.com/us-en/netapp-solutions/virtualization/scv_videos_restore_workflow.html["SnapCenter Plug-in for VMware vSphere - リストアワークフロー"^]
* https://docs.netapp.com/us-en/netapp-solutions/virtualization/scv_videos_sql_restore.html["SnapCenter - SQL リストアワークフロー"^]
