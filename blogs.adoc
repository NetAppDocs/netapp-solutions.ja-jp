...
* link:https://www.netapp.com/blog/cloud-volumes-service-google-cloud-vmware-engine/["NetApp Cloud Volumes Service データストアでGoogle Cloud VMware Engineがサポートされるようになりました"]
