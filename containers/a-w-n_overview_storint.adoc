...
| 展開タイプ | バージョン | ストレージシステム | Tridentバージョン | プロトコル | の機能 
...
NetApp Tridentは、Anthosを含むコンテナとKubernetesディストリビューション向けの、オープンソースで完全サポートされたストレージオーケストレーションツールです。詳細については、TridentのWebサイトを参照して https://docs.netapp.com/us-en/trident/index.html["こちらをご覧ください"]ください。
