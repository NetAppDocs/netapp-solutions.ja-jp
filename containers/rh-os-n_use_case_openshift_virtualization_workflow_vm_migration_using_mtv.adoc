...
image::rh-os-n_use_case_vm_migration_using_mtv.png[RH OS nユースケースMTVを使用したVMの移行]
...
image::rh-os-n_use_case_vm_migration_source_provider.png[RH OS nユースケースVM移行元プロバイダ]
...
image::rh-os-n_use_case_vm_migration_using_mtv_plan_ready.png[RH OS nユースケースMTV Plan Readyを使用したVMの移行]

[Start]*をクリックすると、VMの移行が完了するまでの一連の手順が実行されます。

image::rh-os-n_use_case_vm_migration_using_mtv_plan_complete.png[RH OS nユースケースMTVを使用したVMの移行計画の完了]
