...
21.12.60Ansible プレイブックを使用して Astra Control Center を導入するには、 Ansible がインストールされた Ubuntu / RHEL マシンが必要です。説明に従って、手順 に従います https://docs.netapp.com/us-en/netapp-solutions/automation/automation_ubuntu_debian_setup.html["こちらをご覧ください"] Ubuntu およびそれに含まれています RHEL の場合：
