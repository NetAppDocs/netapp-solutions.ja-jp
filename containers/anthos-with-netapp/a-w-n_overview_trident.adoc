...
Astra Tridentの最新バージョンに関するドキュメントを参照できます https://["こちらをご覧ください"]。Trident のどのバージョンがサポートされているかを確認できます Kubernetes ディストリビューションのテストに使用 https://["こちらをご覧ください"]。
...
Astra Tridentのインストールの詳細については、を参照してください https://["こちらをご覧ください"]。
...
link:a-w-n_overview_advanced.html["次の記事：Anthosの高度な設定オプション"]
