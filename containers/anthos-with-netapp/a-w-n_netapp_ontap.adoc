...
image:a-w-n_ontap.png["エラー：グラフィックイメージがありません"]
...
ネットアップのAFF プラットフォームとFAS プラットフォームの詳細については、をクリックしてください https://docs.netapp.com/platstor/index.jsp["こちらをご覧ください"]。
...
link:a-w-n_netapp_element.html["次へ：NetApp Element"]
