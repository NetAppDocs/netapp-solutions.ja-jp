...
summary: NetAppには、TridentとTrident Protectに認定された複数のストレージプラットフォームがあり、コンテナ化されたアプリケーションのデータをプロビジョニング、保護、管理できるため、DevOpsのスループットの定義と最大化に役立ちます。 
---
= ネットアップストレージシステムの概要
:hardbreaks:
:allow-uri-read: 
...
[role="lead"]
NetAppには、TridentとTrident Protectに認定された複数のストレージプラットフォームがあり、コンテナ化されたアプリケーションのデータをプロビジョニング、保護、管理できるため、DevOpsのスループットの定義と最大化に役立ちます。
