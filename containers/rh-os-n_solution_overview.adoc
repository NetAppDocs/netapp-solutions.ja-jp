...
詳細については、 Astra Trident の Web サイトをご覧ください https://netapp-trident.readthedocs.io/en/stable-v21.07/index.html["こちらをご覧ください"]。
...
| ネットアップアストラト Trident | ストレージオーケストレーション | 21.07.1 
